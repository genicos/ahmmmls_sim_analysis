...
print("count","gens","m","m_miss","lnl0","sel0","lnl1","sel1", sep='\t')

for entry in info:
    m_miss = m_miss_array[info[entry][7]]
    ...
    for i in range(count):
        print(count,gens,m,m_miss,info[entry][1][i],info[entry][2][i],info[entry][3][i], info[entry][4][i],sep='\t')
