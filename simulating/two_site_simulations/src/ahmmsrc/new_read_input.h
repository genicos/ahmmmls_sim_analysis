#ifndef __NEW_READ_INPUT_H
#define __NEW_READ_INPUT_H

void selection_read_file ( cmd_line &options, vector<markov_chain> &markov_chain_information, map<int,vector<vector<int> > > &state_list, vector<int> &position, vector<double> &recombination_rate, vector<string> &chromosomes ) {
